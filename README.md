Наблюдаем блокировки Github в Казахстане что может вызвать недоступность плейлиста с телеканалами но можно решить проблему через обход блокировок VPN/proxy/Zapret/ByebyeDPI.
